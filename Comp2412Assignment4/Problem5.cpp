 ...
 */
void Problem5::generateArrayOf100RandomIntegers() {
 ...
 */
Node* Problem5::insert(int arrayOfIntegers[7], Node* nodeToInsert) {
 ...
 */
Node* Problem5::makeEmpty(Node* nodeReference) {
 ...
 */
int Problem5::calculateSumOfArrayValues(int arrayOfIntegers[7]) {
	int sum = 0;
	for (int i = 0; i < 7; i++) {
 ...
 */
void Problem5::printInOrder(Node* nodeReference) {
	if (nodeReference == NULL) {
		return;
	}
